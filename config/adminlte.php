...
return [
    ...
    */
    ...
    'logo' => 'CardioProtegido',
    //'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img' => 'logo-interior.png',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Marcas',
                    'url' => 'marcas/lista',
                    'active' => ['marcas/editar', 'marcas/agregar', 'regex:@^marcas/editar/[A-Za-z0-9-]+$@',],
                ],
                [
                    'text' => 'Modelos',
                    'url' => 'modelos/lista',
                    'active' => ['modelos/editar', 'modelos/agregar', 'regex:@^modelos/editar/[A-Za-z0-9-]+$@',],
                ],
                [
                    'text' => 'Productos',
                    'url' => 'productos/lista',
