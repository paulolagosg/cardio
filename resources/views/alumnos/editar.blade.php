...
<span class="text-xl text-bold text-dark">Alumnos</span> <span> Modificar</span>
@stop
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <form method="post" id="fAlumnos" action="{{route('alumnos.actualizar')}}">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="id_version" name="id_version" class="form-control select2" style="width:100%">
                                            ...
                                            <option value="{{$version->id}}" @if($version->id == $datos->id_version) selected @endif>{{$version->nombre}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rut" name="rut" placeholder="11111111-1" value="{{$datos->rut}}" required>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="correo_electronico" name="correo_electronico" placeholder="correo@dominio.cl" value="{{$datos->correo_electronico}}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nota" name="nota" placeholder="6.0" value="{{$datos->nota}}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="asistencia" name="asistencia" placeholder="85" value="{{$datos->asistencia}}" required>
                                        <span id="error_asistencia" class="error">Debe ingresar una asistencia válida</span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <button type="button" onclick="validar_alumno()" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
