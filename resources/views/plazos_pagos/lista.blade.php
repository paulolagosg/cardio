...
@section('title', 'Plazos Pago')

@section('content_header')
<span class="text-xl text-bold text-dark">Plazos Pago</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/plazos_pagos/agregar" urlEditar="/plazos_pagos/editar" urlEliminar="/plazos_pagos/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
