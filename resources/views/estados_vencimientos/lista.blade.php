...
@section('title', 'Estados Vencimientos')

@section('content_header')
<span class="text-xl text-bold text-dark">Estados Vencimientos</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/estados_vencimientos/agregar" urlEditar="/estados_vencimientos/editar" urlEliminar="/estados_vencimientos/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
