...
<span class="text-xl text-bold text-dark">Usuarios</span> <span> Lista</span>
@stop
@section('content')
<div class="card card-dark">
    ...
    <div class="card-body table-responsive">
        <p class="text-right"><a href="{{route('usuarios.agregar')}}" class="btn text-white" style="background-color: #811916;"><i class="fa fa-plus-circle"></i> Agregar</a></p>
        <table id="tablaParametros" class="table table-bordered table-hover dataTable dtr-inline table-striped" aria-describedby="example2_info">
            <thead>
                ...
                <tr>
                    ...
                    <th class="th2">Correo Electrónico</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left">{{$d->telefono}}</td>
                    <td class="text-center"><a href="{{route('usuarios.editar',$d->id)}}"><i class="fa fa-edit text-dark" data-toggle="tooltip" data-placement="top" title="Modificar"></i></a>&nbsp;
                        <a href="#" onclick="eliminar('/usuarios/eliminar/',{{$d->id}})"><i class="fa fa-trash text-danger" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
