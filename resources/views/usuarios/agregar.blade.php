...
<span class="text-xl text-bold text-dark">Usuarios</span> <span> Agregar</span>
@stop
@section('content')
<div class="card card-dark">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="fUsuario" method="POST" action="{{route('usuarios.crear')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="telefono" name="telefono" value="" required />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span id="error_password" class="error">Debe ingresar una contraseña</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
