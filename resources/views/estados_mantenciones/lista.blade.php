...
@section('title', 'Estados Mantenciones')

@section('content_header')
<span class="text-xl text-bold text-dark">Estados Mantenciones</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/estados_mantenciones/agregar" urlEditar="/estados_mantenciones/editar" urlEliminar="/estados_mantenciones/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
