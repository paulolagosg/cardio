...
@section('title', 'Tiempos Entrega')

@section('content_header')
<span class="text-xl text-bold text-dark">Tiempos Entrega</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/tiempos_entregas/agregar" urlEditar="/tiempos_entregas/editar" urlEliminar="/tiempos_entregas/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
