...
@section('title', 'Tipos Mantenciones')

@section('content_header')
<span class="text-xl text-bold text-dark">Tipos Mantenciones</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/tipos_mantenciones/agregar" urlEditar="/tipos_mantenciones/editar" urlEliminar="/tipos_mantenciones/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
