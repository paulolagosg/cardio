...
<span class="text-xl text-bold text-dark">Marcas</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/marcas/agregar" urlEditar="/marcas/editar" urlEliminar="/marcas/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
