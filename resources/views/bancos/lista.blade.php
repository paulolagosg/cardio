...
<span class="text-xl text-bold text-dark">Bancos</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/bancos/agregar" urlEditar="/bancos/editar" urlEliminar="/bancos/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
