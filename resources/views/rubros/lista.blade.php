...
<span class="text-xl text-bold text-dark">Rubros</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/rubros/agregar" urlEditar="/rubros/editar" urlEliminar="/rubros/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
