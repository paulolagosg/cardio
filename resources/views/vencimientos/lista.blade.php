...
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/vencimientos/agregar" urlEditar="/vencimientos/editar" urlEliminar="/vencimientos/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
