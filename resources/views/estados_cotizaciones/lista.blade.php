...
@section('title', 'Estados Cotizaciones')

@section('content_header')
<span class="text-xl text-bold text-dark">Estados Cotizaciones</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/estados_cotizaciones/agregar" urlEditar="/estados_cotizaciones/editar" urlEliminar="/estados_cotizaciones/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
