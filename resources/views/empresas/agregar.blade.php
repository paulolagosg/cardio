...
@section('title', 'Empresas - Agregar')

@section('content_header')
<span class="text-xl text-bold text-dark">Empresas</span> <span> Agregar</span>
@stop
...
<div class="card  card-dark">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" id="fEmpresas" action="{{route('empresas.crear')}}" enctype="multipart/form-data">
                    <div class="card card-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="correo_electronico" name="correo_electronico" placeholder="correo@dominio.com" value="{{old('correo_electronico')}}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sitio_web" name="sitio_web" placeholder="www.sitio.cl" value="{{old('sitio_web')}}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="numero_cuenta" name="numero_cuenta" placeholder="88888888" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" onclick="validar_empresa()" class="btn btn-success"><i class="fa fa-save"></i> Agregar</button>
