...
<span class="text-xl text-bold text-dark">Empresas</span> <span> Lista</span>
@stop
@section('content')
<div class="card card-dark">
    ...
    <div class="card-body table-responsive">
        <p class="text-right"><a href="{{route('empresas.agregar')}}" class="btn text-white" style="background-color: #811916;"><i class="fa fa-plus-circle"></i> Agregar</a></p>
        <table id="tablaParametros" class="table table-bordered table-hover dataTable dtr-inline table-striped" aria-describedby="example2_info">
            <thead>
                <tr>
                    ...
                    <th class="sorting text-center">Giro</th>
                    ...
                    <th class="sorting text-center">Sitio Web</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="">{{$d->giro}}</td>
                    <td class="text-left">{{$d->correo_electronico}}</td>
                    <td class="text-left">{{$d->direccion}}</td>
                    <td class="text-right">{{$d->telefono}}</td>
                    <td class="">{{$d->sitio_web}}</td>
                    <td class="text-center">
                        <a href="/empresas/editar/{{$d->id}}"><i class="fa fa-edit text-dark" data-toggle="tooltip" data-placement="top" title="Modificar"></i></a>&nbsp;
                        <!-- <a href="#" onclick="eliminar('/empresas/eliminar/',{{$d->id}})"><i class="fa fa-trash text-danger" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></a> -->
                    </td>
                </tr>
                @endforeach
            </tbody>
