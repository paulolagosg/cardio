...
<span class="text-xl text-bold text-dark">Formas de Pago</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/formas_pago/agregar" urlEditar="/formas_pago/editar" urlEliminar="/formas_pago/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
