...
<span class="text-xl text-bold text-dark">Tipos Productos</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/tipos_productos/agregar" urlEditar="/tipos_productos/editar" urlEliminar="/tipos_productos/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
