...
<span class="text-xl text-bold text-dark">Modalidades</span> <span> Lista</span>
@stop
@section('content')
<x-index-parametros titulo="" urlAgregar="/modalidades/agregar" urlEditar="/modalidades/editar" urlEliminar="/modalidades/eliminar/" :datos="$datos" idTabla="tablaParametros" />
@stop
@section('css')
