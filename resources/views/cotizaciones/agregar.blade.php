...
@section('title', 'Cotizaciones - Agregar')

@section('content_header')
<span class="text-xl text-bold text-dark">Cotizaciones</span> <span> Nueva</span>
@stop
...
<div class="card  card-dark">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" id="fCotizacion" action="{{route('cotizaciones.crear')}}" enctype="multipart/form-data">
                    <div class="card card-dark">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_usuario" name="id_usuario" required style="width:100%">
                                            ...
                                            <option value="{{$usuario->id}}" {{old('id_usuario') == $usuario->id
                                                ? 'selected' : ''}} {{Auth::user()->id == $usuario->id
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="giro" name="giro" value="{{old('giro')}}" placeholder="Giro" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="999999999" value="{{old('telefono')}}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_tipo_transporte" name="id_tipo_transporte" required style="width:100%" onchange="habilita_costo(this.value)">
                                            ...
                                            <option value="{{$t->id}}" {{old('id_tipo_transporte') == $t->id ? 'selected' : ''}}>{{$t->nombre }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="costo_envio" name="costo_envio" value="{{old('costo_envio')}}" disabled />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_tipo_pago" name="id_tipo_pago" required>
                                            ...
                                            <option value="{{$t->id}}" {{old('id_tipo_pago') ==
                                        $t->id ? 'selected' : ''}}>{{$t->nombre }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_plazo_pago" name="id_plazo_pago" required>
                                            ...
                                            <option value="{{$t->id}}" {{old('id_plazo_pago') ==$t->id ? 'selected' : ''}}>{{$t->nombre }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_tiempo_entrega" name="id_tiempo_entrega" required>
                                            ...
                                            <option value="{{$t->id}}" {{old('id_tiempo_entrega') ==$t->id ? 'selected' : ''}}>{{$t->nombre }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row p-2">
                            <div class="col-12">
                                <button type="button" onclick="validar_cotizacion()" class="btn btn-success"><i class="fa fa-save"></i> Agregar</button>
...
<script>
    ...
    //     // Obtiene la fila a eliminar desde el botón presionado
    //     let fila = boton.parentNode.parentNode;
    //     fila.parentNode.removeChild(fila);

    //     // Actualiza los totales después de eliminar la fila
    //     actualizarTotales();
    // }
