...
<span class="text-xl text-bold text-dark">Versiones</span> <span> Agregar</span>
@stop
@section('content')
<div class="card card-dark">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="fVersiones" method="POST" action="{{route('versiones.crear')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fecha_curso" name="fecha_curso" value="" required />
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="horas" name="horas" value="" required />
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="rut" name="rut" placeholder="99999999-9" value="">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="contraparte" name="contraparte" placeholder="Nombre" value="">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="888888888" value="">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" id="correo_electronico" name="correo_electronico" value="" placeholder="Correo electrónico">
