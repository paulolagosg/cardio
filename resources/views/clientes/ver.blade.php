    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="{{old('nombre',$datos->nombre)}}" required disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="razon_social" name="razon_social" placeholder="Razón social" value="{{old('razon_social',$datos->razon_social)}}" required disabled>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="id_rubro" name="id_rubro" required disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Dirección" required value="{{$datos->direccion}}" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="888888888" value="{{old('telefono',$datos->telefono)}}" disabled />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="correo" name="correo"
                                            placeholder="Correo electrónico" value="{{old('correo',$datos->correo)}}" disabled />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sitio_web" name="sitio_web" placeholder="Sitio Web" value="{{old('sitio_web',$datos->sitio_web)}}" disabled />
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                    <a href="{{route('clientes.clientes_region',$codigo_region->codigo)}}" class="btn text-white" style="background-color: #87161b"><i class="fa fa-arrow-left"></i> Volver</a>
                </div>
                </form>
            </div>
        </div>
