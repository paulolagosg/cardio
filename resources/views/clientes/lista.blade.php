...
<span class="text-xl text-bold text-dark">Clientes</span> <span> Lista</span>
@stop
@section('content')
<div class="card card-dark">
    ...
    <div class="card-body table-responsive">
        <p class="text-right"><a href="{{route('clientes.agregar')}}" class="btn text-white" style="background-color: #811916;"><i class="fa fa-plus-circle"></i> Agregar</a></p>
