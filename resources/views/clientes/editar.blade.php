                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="latitud" name="latitud" value="{{$datos->latitud}}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">Longitud (GoogleMaps)</label>
                                        <input type="email" class="form-control" id="longitud" name="longitud" value="{{$datos->longitud}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre_principal" name="nombre_principal" value="{{$contacto_principal->nombre}}" placeholder="Nombre" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="telefono">Teléfono</label>
                                            <input type="text" class="form-control" id="telefono_principal" name="telefono_principal" value="{{$contacto_principal->telefono}}" placeholder="888888888" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="email">Correo electrónico</label>
                                            <input type="email" class="form-control" id="correo_principal" name="correo_principal" placeholder="Correo electrónico" value="{{$contacto_principal->correo_electronico}}" />
