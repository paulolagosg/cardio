...
<span class="text-xl text-bold text-dark">Clientes {{ucfirst($datos[0]->comuna)}}</span>
@stop
@section('content')
<div class="card card-dark">
    ...
    <div class="card-body table-responsive">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('clientes.clientes_comunas',$d->region)}}" class="btn text-white" style="background-color: #87161b"><i class="fa fa-arrow-left"></i> Volver</a>
            </div>
        </div>
    </div>
